 ...
 ******************************************************************************/
package com.agilecrm.bria.data;
...
public class Call {
	...
	public boolean isConnecting() {
		for (Participant participant : participants) {
			if (participant.getState() == ParticipantStateType.CONNECTING) {
				return true;
			}
		}
		return false;
	...
	public boolean isFailed() {
		for (Participant participant : participants) {
			if (participant.getState() == ParticipantStateType.FAILED) {
				return true;
			}
		}
		return false;
	...
	public boolean isEnded() {
		for (Participant participant : participants) {
			if (participant.getState() == ParticipantStateType.ENDED) {
				return true;
			}
		}
		return false;
